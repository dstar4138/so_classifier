%% CalcGradient.m
%% 
%%  Calculates the gradient for a particular point given
%%  the variance of each class and the mean of each class,
%%  for the particular factor the point belongs to. Note
%%  that since most datums we are working with are continuous
